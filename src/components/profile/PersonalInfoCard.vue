        ...
        <div class="w-full">
          ...
          <div v-else class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            <div>
              ...
              <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ userProfile?.name || 'Not specified' }}</p>
            </div>
            ...
            <div>
              ...
              <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ userProfile?.phone || 'Not specified' }}</p>
            </div>

            <div>
              <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Bio</p>
              <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ userProfile?.bio || 'Not specified' }}</p>
            </div>
