  ...
  <div class="relative" ref="multiSelectRef">
    <div
      ...
      :class="{ 
        ...
        'border-brand-300 ring-3 ring-brand-500/10 dark:border-brand-800': isOpen,
        'border-gray-300 dark:border-gray-700': !isOpen
      }"
    >
      <span v-if="selectedItems.length === 0" class="text-gray-400 dark:text-gray-500">{{ props.placeholder }}</span>
