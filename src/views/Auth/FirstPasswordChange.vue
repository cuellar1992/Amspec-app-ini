...
// Get tempToken from route query params
const tempToken = computed(() => route.query.tempToken as string)
...
const handleSubmit = async () => {
  ...
  try {
    ...
    // Call first password change API
    const response = await authService.firstPasswordChange(
      tempToken.value,
    ...
    errorMessage.value = authError.message || 'Failed to change password. Please try again.'
  } finally {
    isLoading.value = false
  }
}
